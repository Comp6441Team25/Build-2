...
/**
 * gameBoard class displays the graphical view of the current state of the game. It displays all the pieces that are currently on the board. 
 * @author dell
 */
