...
import static view.first_page.active_turn;
import static view.first_page.image1;
import static view.first_page.playerObj;
...
/**
 *  this class displays the actual game state fro the current player and if player ends his turn,
 *  next player will be activated who is assigned the next turn. Game can be saved at any state.
 *  Player needs to provide name for a file which is being stored.
 * @author Dell
 */
...
/**
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        bank.payment(playerObj[active_turn].cashInHand);
                ...
                bank.fund(playerObj[active_turn].cashInHand);
        Acash.setText(String.valueOf(playerObj[active_turn].cashInHand));
        bankText.setText(String.valueOf(bank.cash));
