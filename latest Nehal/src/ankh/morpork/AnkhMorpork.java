...
public class AnkhMorpork {
    ...
    public static Stack<String> usedStack = new Stack<String>();
	...
	public static void deck(Collection<String> green, Collection<String> brown){
        ...
        public boolean next_turn(int i){
            ...
            for (int j=0;j<first_page.playerObj.length;j++) 
                ...
                for(int j=0;j<5;j++){
                    System.out.println("details of active player: " + first_page.playerObj[i].CardsInHand.get(j));
                }
        return true;}
            return false;
        }
        ...
        if(players.length>=2 && players.length<5)
        {
            ...
            for(int i=0;i<players.length;i++){
                for(int j=0;j<5;j++)
                {
                    ...
                    first_page.playerObj[i].CardsInHand.add(details[i][j]);
                }
